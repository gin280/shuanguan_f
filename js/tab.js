...
$('.s4-tab li:nth-child(2)').find('span').addClass('s2-show');
	...
	$('.s4-tab li').click(function(index) {
		$(this).addClass('s4-active').siblings().removeClass('s4-active');
		var tab3 = $(this).attr('data-title');
		$('#'+tab3).show().siblings().hide();
	}); //s4
	$('.s4-tab-tab li').click(function() {
		$(this).addClass('s4-tab-tab-active').siblings().removeClass('s4-tab-tab-active');
		var tab3 = $(this).attr('data-title');
		$('#'+tab3).show().siblings().hide();
	}); //s4
	$('.s3-tab li').click(function() {
		$(this).addClass('s3-t').siblings().removeClass('s3-t');
		var tab3 = $(this).attr('data-title');
		$('#'+tab3).show().siblings().hide();
	}); //s4
